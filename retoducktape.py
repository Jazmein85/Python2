...
class Oyente(Persona):
    def __init__(self, nombre, apellidos, edad, carrera_oyente, calificaciones_oyente):
            super().__init__(nombre, edad, apellidos)
            self.carrera = carrera_oyente
            self.calificaciones = calificaciones_oyente
    def aprobado(self):
        return False
...
alumno_4 = Oyente('Pedro', 'Perez', 22, 'Periodismo', [0, 0, 0])
